...
System.out.println("=== Voting Eligibility System Automated Runner ===");
...
Voter[] testVoters = {
    ...
    new Voter("David Miller", 16, "British", "NONE", false)
};

for (Voter voter : testVoters) {
    displayEligibilityReport(voter);
}

System.out.println("\nAll automated evaluation cycles complete.");

}

private static void displayEligibilityReport(Voter voter) {
